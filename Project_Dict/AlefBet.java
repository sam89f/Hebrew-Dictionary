   ...
   public void AlefBet()
	{
		...
		alef_bet.put("à", values[1]);	   
		alef_bet.put("á", values[2]);	  
		alef_bet.put("â", values[3]);	   
		alef_bet.put("ã", values[4]);
		alef_bet.put("ä", values[5]);	   
		alef_bet.put("å", values[6]);	  
		alef_bet.put("æ", values[7]);	   
		alef_bet.put("ç", values[8]);	
		alef_bet.put("è", values[9]);	   
		alef_bet.put("é", values[10]);	  
		alef_bet.put("ë", values[11]);	   
		alef_bet.put("ì", values[12]);
		alef_bet.put("î", values[13]);	   
		alef_bet.put("ð", values[14]);	  
		alef_bet.put("ñ", values[15]);	   
		alef_bet.put("ò", values[16]);	
		alef_bet.put("ô", values[17]);	   
		alef_bet.put("ö", values[18]);	  
		alef_bet.put("÷", values[19]);	   
		alef_bet.put("ø", values[20]);
		alef_bet.put("ù", values[21]);	   
		alef_bet.put("ú", values[22]);	  
		alef_bet.put("ê", values[23]);	   
		alef_bet.put("í", values[24]);
		alef_bet.put("ï", values[25]);	   
		alef_bet.put("ó", values[26]);	  
		alef_bet.put("õ", values[27]);	   
}
